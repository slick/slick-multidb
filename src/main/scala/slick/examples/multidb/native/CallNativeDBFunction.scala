package slick.examples.multidb.native
...
object CallNativeDBFunction extends App {
  ...
  private val salesPerDay = TableQuery[SalesPerDay]

  private val dayOfWeek = SimpleFunction.unary[Date, Int]("day_of_week")

  private val dayOfWeek2 = SimpleFunction[Int]("day_of_week")
